...
| Starting an internal chat (or adding someone to one) WhatsApps the people put in it, inviting them to sign in and read it | `Team\Chat::invite` → `Notify\StaffAlert::toUser(..., prefer: whatsapp)` |
